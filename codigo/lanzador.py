...
def ejercicio():
    ...
    if eleccion == 1:
        print("La solucion a la primera ecuación propuesta es: \n")
        ecuacion1()
    elif eleccion == 2:
        print("La solucion a la segunda ecuación propuesta es: \n")
        ecuacion2()
    elif eleccion == 3:
        print("La solucion a la tercera ecuación propuesta es: \n")
        ecuacion3()
    elif eleccion == 4:
        print("La solucion a la cuarta ecuación propuesta es: \n")
        ecuacion4()